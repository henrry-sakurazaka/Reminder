...
function dr(c) {
  if (b === setTimeout) return setTimeout(c, 0);
  if ((b === er || !b) && setTimeout) return (b = setTimeout), setTimeout(c, 0);
  try {
    return b(c, 0);
  } catch {
    try {
...
function Jr() {
  !q ||
    !O ||
    ((q = !1), O.length ? (M = O.concat(M)) : (V = -1), M.length && mr());
}
function mr() {
  if (!q) {
    var c = dr(Jr);
...
g.nextTick = function (c) {
  ...
  if (arguments.length > 1)
    for (var l = 1; l < arguments.length; l++) f[l - 1] = arguments[l];
...
function rt(c) {
  ...
  for (B = 0; B < I; B += 4)
    (f =
      (C[c.charCodeAt(B)] << 18) |
      (C[c.charCodeAt(B + 1)] << 12) |
      (C[c.charCodeAt(B + 2)] << 6) |
      C[c.charCodeAt(B + 3)]),
      (p[s++] = (f >> 16) & 255),
      (p[s++] = (f >> 8) & 255),
      (p[s++] = f & 255);
  return (
    w === 2 &&
      ((f = (C[c.charCodeAt(B)] << 2) | (C[c.charCodeAt(B + 1)] >> 4)),
      (p[s++] = f & 255)),
    w === 1 &&
      ((f =
        (C[c.charCodeAt(B)] << 10) |
        (C[c.charCodeAt(B + 1)] << 4) |
        (C[c.charCodeAt(B + 2)] >> 2)),
      (p[s++] = (f >> 8) & 255),
      (p[s++] = f & 255)),
    p
  );
...
function et(c, f, l) {
  for (var x, w = [], p = f; p < l; p += 3)
    (x =
      ((c[p] << 16) & 16711680) + ((c[p + 1] << 8) & 65280) + (c[p + 2] & 255)),
      w.push(tt(x));
  return w.join('');
}
function nt(c) {
  for (
    var f, l = c.length, x = l % 3, w = [], p = 16383, s = 0, I = l - x;
    s < I;
    s += p
  )
  ...
  return (
    x === 1
      ? ((f = c[l - 1]), w.push(L[f >> 2] + L[(f << 4) & 63] + '=='))
      : x === 2 &&
        ((f = (c[l - 2] << 8) + c[l - 1]),
        w.push(L[f >> 10] + L[(f >> 4) & 63] + L[(f << 2) & 63] + '=')),
    w.join('')
  );
}
var ir = {};
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ ir.read =
  function (c, f, l, x, w) {
    var p,
      ...
      R = c[f + A];
    for (
      A += N, p = R & ((1 << -o) - 1), R >>= -o, o += I;
      o > 0;
      p = p * 256 + c[f + A], A += N, o -= 8
    );
    for (
      s = p & ((1 << -o) - 1), p >>= -o, o += x;
      o > 0;
      s = s * 256 + c[f + A], A += N, o -= 8
    );
    if (p === 0) p = 1 - T;
    else {
      if (p === B) return s ? NaN : (R ? -1 : 1) * (1 / 0);
...
ir.write = function (c, f, l, x, w, p) {
  ...
  for (
    f = Math.abs(f),
      isNaN(f) || f === 1 / 0
        ? ((I = isNaN(f) ? 1 : 0), (s = o))
        : ((s = Math.floor(Math.log(f) / Math.LN2)),
          f * (B = Math.pow(2, -s)) < 1 && (s--, (B *= 2)),
          s + A >= 1 ? (f += N / B) : (f += N * Math.pow(2, 1 - A)),
          f * B >= 2 && (s++, (B /= 2)),
          s + A >= o
            ? ((I = 0), (s = o))
            : s + A >= 1
              ? ((I = (f * B - 1) * Math.pow(2, w)), (s = s + A))
              : ((I = f * Math.pow(2, A - 1) * Math.pow(2, w)), (s = 0)));
    w >= 8;
    c[l + R] = I & 255, R += P, I /= 256, w -= 8
  );
  for (
    s = (s << w) | I, T += w;
    T > 0;
    c[l + R] = s & 255, R += P, s /= 256, T -= 8
  );
  c[l + R - P] |= J * 128;
};
/*!
 ...
 */ (function (c) {
  ...
  function A(e, r, t) {
    ...
    if (
      _(e, s) ||
      (e && _(e.buffer, s)) ||
      (typeof I < 'u' && (_(e, I) || (e && _(e.buffer, I))))
    )
      return Q(e, r, t);
    if (typeof e == 'number')
      throw new TypeError(
  ...
  function z(e) {
    const r = e.length < 0 ? 0 : K(e.length) | 0,
      t = T(r);
  ...
  (o.isBuffer = function (r) {
    ...
    (o.compare = function (r, t) {
      if (
        (_(r, p) && (r = o.from(r, r.offset, r.byteLength)),
        _(t, p) && (t = o.from(t, t.offset, t.byteLength)),
    ...
    (o.concat = function (r, t) {
      ...
      for (n = 0; n < r.length; ++n) {
        ...
        if (_(h, p))
          u + h.length > i.length
            ? (o.isBuffer(h) || (h = o.from(h)), h.copy(i, u))
            : p.prototype.set.call(i, h, u);
        else if (o.isBuffer(h)) h.copy(i, u);
  ...
  function or(e, r) {
    ...
    if (s.isView(e) || _(e, s)) return e.byteLength;
    if (typeof e != 'string')
      throw new TypeError(
  ...
  (o.prototype.swap16 = function () {
    ...
    for (let t = 0; t < r; t += 2) $(this, t, t + 1);
    return this;
  }),
    (o.prototype.swap32 = function () {
      ...
      for (let t = 0; t < r; t += 4) $(this, t, t + 3), $(this, t + 1, t + 2);
      return this;
    }),
  ...
  function ur(e, r, t, n, i) {
    ...
    if (typeof r == 'number')
      return (
        (r = r & 255),
        typeof p.prototype.indexOf == 'function'
          ? i
            ? p.prototype.indexOf.call(e, r, t)
            : p.prototype.lastIndexOf.call(e, r, t)
          : hr(e, [r], t, n, i)
      );
        ...
        switch (a) {
          ...
          case 3:
            (d = e[i + 1]),
              ...
              (d & 192) === 128 &&
                (E & 192) === 128 &&
                ((y = ((u & 15) << 12) | ((d & 63) << 6) | (E & 63)),
                y > 2047 && (y < 55296 || y > 57343) && (h = y));
            break;
          case 4:
            (d = e[i + 1]),
              (E = e[i + 2]),
  ...
  function Mr(e) {
    const r = e.length;
    if (r <= fr) return String.fromCharCode.apply(String, e);
    let t = '',
      n = 0;
    for (; n < r; )
      t += String.fromCharCode.apply(String, e.slice(n, (n += fr)));
    return t;
  }
  function Dr(e, r, t) {
    let n = '';
  ...
  (o.prototype.readUintLE = o.prototype.readUIntLE =
    ...
    (o.prototype.readUint16LE = o.prototype.readUInt16LE =
      function (r, t) {
        return (
          (r = r >>> 0), t || F(r, 2, this.length), this[r] | (this[r + 1] << 8)
        );
      }),
    (o.prototype.readUint16BE = o.prototype.readUInt16BE =
      function (r, t) {
        return (
          (r = r >>> 0), t || F(r, 2, this.length), (this[r] << 8) | this[r + 1]
        );
      }),
    ...
    (o.prototype.readFloatLE = function (r, t) {
      return (
        (r = r >>> 0), t || F(r, 4, this.length), l.read(this, r, !0, 23, 4)
      );
    }),
    (o.prototype.readFloatBE = function (r, t) {
      return (
        (r = r >>> 0), t || F(r, 4, this.length), l.read(this, r, !1, 23, 4)
      );
    }),
    (o.prototype.readDoubleLE = function (r, t) {
      return (
        (r = r >>> 0), t || F(r, 8, this.length), l.read(this, r, !0, 52, 8)
      );
    }),
    (o.prototype.readDoubleBE = function (r, t) {
      return (
        (r = r >>> 0), t || F(r, 8, this.length), l.read(this, r, !1, 52, 8)
      );
    });
  ...
  (o.prototype.writeBigUInt64LE = k(function (r, t = 0) {
    ...
    (o.prototype.writeIntLE = function (r, t, n, i) {
      ...
      for (this[t] = r & 255; ++u < n && (h *= 256); )
        r < 0 && a === 0 && this[t + u - 1] !== 0 && (a = 1),
          (this[t + u] = (((r / h) >> 0) - a) & 255);
      return t + n;
    }),
  ...
  (o.prototype.writeDoubleLE = function (r, t, n) {
    ...
    (o.prototype.copy = function (r, t, n, i) {
      ...
      const u = i - n;
      return (
        this === r && typeof p.prototype.copyWithin == 'function'
          ? this.copyWithin(t, n, i)
          : p.prototype.set.call(r, this.subarray(n, i), t),
        u
      );
    }),
    (o.prototype.fill = function (r, t, n, i) {
      ...
      if (typeof r == 'number') for (u = t; u < n; ++u) this[u] = r;
        ...
        const h = o.isBuffer(r) ? r : o.from(r, i),
          a = h.length;
        if (a === 0)
          throw new TypeError(
            'The value "' + r + '" is invalid for argument "value"'
          );
        for (u = 0; u < n - t; ++u) this[u + t] = h[u % a];
      }
      return this;
    });
  const G = {};
  ...
  function Or(e, r, t) {
    Y(r, 'offset'),
      (e[r] === void 0 || e[r + t] === void 0) && W(r, e.length - (t + 1));
  }
  function xr(e, r, t, n, i, u) {
    if (e > t || e < r) {
      ...
      throw (
        (r === 0 || r === BigInt(0)
          ? (a = `>= 0${h} and < 2${h} ** ${(u + 1) * 8}${h}`)
          : (a = `>= -(2${h} ** ${(u + 1) * 8 - 1}${h}) and < 2 ** ${(u + 1) * 8 - 1}${h}`),
        new G.ERR_OUT_OF_RANGE('value', a, e))
      );
    }
    Or(n, i, u);
  }
  function Y(e, r) {
    if (typeof e != 'number') throw new G.ERR_INVALID_ARG_TYPE(r, 'number', e);
  }
  function W(e, r, t) {
    throw Math.floor(e) !== e
      ? (Y(e, t), new G.ERR_OUT_OF_RANGE('offset', 'an integer', e))
      : r < 0
        ? new G.ERR_BUFFER_OUT_OF_BOUNDS()
        : new G.ERR_OUT_OF_RANGE('offset', `>= 0 and <= ${r}`, e);
  }
...
const ht = Ir.Buffer;
export { ht as B, it as g, ot as p };
