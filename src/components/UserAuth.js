            ...
            <div className="container">
                ...
                <div className="circle2">
                    <div className="inner9-container">
                        <span className="select-auth sign-up" id="SU" onClick={() => handleClickSignUp()}>Sign Up</span>
                        <span className="select-auth sign-in" id="SI" onClick={() => handleClickSignIn()}>Sign In</span>
                        <span className="select-auth sign-out" id="SO" onClick={() => handleClickSignOut()}>Sign Out</span>
                        <span className="select-auth easy-login" onClick={() => handleClickEasyLogin()}>お試しログイン</span>
                        <span className="select-auth delete-account" id="DA" onClick={() => handleDeleteAccount()}>Delete Account</span>
                    </div>
                </div> 
                { message() }
            </div> 
