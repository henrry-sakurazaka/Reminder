...
const Modal = ({ todo }) => {
    ...
    if (!isSupported) {
      return (
        <div className="warning-message">
          <p className="warning">
            This browser does not supported notifications
          </p>
        </div>
      );
    }
  ...
  return modalOpen ? (
    <div
      ...
      style={{
        backgroundColor:
          shouldHandleNotifications && completedDateTimeSetting && timeCheck
            ? 'transparent'
    ...
    >
      ...
      <div className="btn-container">
        <button
          className="set-btn"
          onClick={() => setTimer(todo)}
          style={{
            color:
              shouldHandleNotifications && timeCheck
                ? 'rgb(8, 232, 158)'
