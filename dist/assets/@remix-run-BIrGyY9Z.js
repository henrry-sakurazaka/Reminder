...
function oe(e) {
  e === void 0 && (e = {});
  function t(a, r) {
    let { pathname: i, search: o, hash: s } = a.location;
    return B(
      '',
...
function k(e, t, n, a) {
  a === void 0 && (a = {});
  let { window: r = document.defaultView, v5Compat: i = !1 } = a,
    o = r.history,
    s = v.Pop,
    l = null,
    c = f();
  c == null && ((c = 0), o.replaceState(P({}, o.state, { idx: c }), ''));
  function f() {
...
function U(e, t, n, a) {
  ...
  return (
    e.forEach((i, o) => {
      var s;
      if (i.path === '' || !((s = i.path) != null && s.includes('?'))) r(i, o);
      else for (let l of H(i.path)) r(i, o, l);
    }),
    t
  );
}
...
function J(e, t) {
  ...
  return (
    ...
    n
      .filter((r) => !b(r))
      .reduce((r, i) => r + (z.test(i) ? _ : i === '' ? D : F), a)
  );
}
function K(e, t) {
...
function X(e, t) {
  ...
  let [n, a] = Y(e.path, e.caseSensitive, e.end),
    r = t.match(n);
  if (!r) return null;
  let i = r[0],
    o = i.replace(/(.)\/+$/, '$1'),
    s = r.slice(1);
  return {
    params: a.reduce((c, f, h) => {
      let { paramName: p, isOptional: $ } = f;
      if (p === '*') {
        let m = s[h] || '';
    ...
    r =
      ...
      e
        ...
        .replace(
          /\/:([\w-]+)(\?)?/g,
          (o, s, l) => (
            a.push({ paramName: s, isOptional: l != null }),
            l ? '/?([^\\/]+)?' : '/([^\\/]+)'
          )
        );
  return (
...
function ue(e, t) {
  let n = ae(e);
  return t
    ? n.map((a, r) => (r === n.length - 1 ? a.pathname : a.pathnameBase))
...
function he(e, t, n, a) {
  ...
  typeof e == 'string'
    ...
    : ((r = P({}, e)),
      ...
      y(!r.search || !r.search.includes('#'), L('#', 'search', 'hash', r)));
  let i = e === '' || r.pathname === '',
    o = i ? '/' : r.pathname,
    s;
  if (o == null) s = n;
