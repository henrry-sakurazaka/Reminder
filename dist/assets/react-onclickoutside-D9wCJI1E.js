...
function C(e, r, o) {
  return e === r
    ...
    : e.correspondingElement
      ? e.correspondingElement.classList.contains(o)
      : e.classList.contains(o);
}
function b(e, r, o) {
  if (e === r) return !0;
  for (; e.parentNode || e.host; ) {
    if (e.parentNode && C(e, r, o)) return !0;
...
var w = function () {
  if (!(typeof window > 'u' || typeof window.addEventListener != 'function')) {
    var r = !1,
      ...
      s = function () {};
    return (
      window.addEventListener('testPassiveEventSupport', s, o),
      window.removeEventListener('testPassiveEventSupport', s, o),
      r
    );
  }
};
...
function L(e, r) {
  ...
  return (
    (s = o =
      (function (c) {
        ...
        function l(a) {
          var t;
          return (
            (t = c.call(this, a) || this),
            (t.__outsideClickHandler = function (n) {
              if (typeof t.__clickOutsideHandlerProp == 'function') {
                t.__clickOutsideHandlerProp(n);
                return;
              }
              var i = t.getInstance();
              if (typeof i.props.handleClickOutside == 'function') {
                i.props.handleClickOutside(n);
                return;
              }
              if (typeof i.handleClickOutside == 'function') {
                i.handleClickOutside(n);
                return;
              }
              throw new Error(
                'WrappedComponent: ' +
            ...
            (t.__getComponentNode = function () {
              var n = t.getInstance();
              return typeof n.setClickOutsideRef == 'function'
                ...
                n.forEach || (n = [n]),
                  (p[t._uid] = function (i) {
                    if (
                      ...
                      !(t.initTimeStamp > i.timeStamp) &&
                      (t.props.preventDefault && i.preventDefault(),
                      t.props.stopPropagation && i.stopPropagation(),
                      !(t.props.excludeScrollbar && P(i)))
                    ) {
                      var f =
                        (i.composed &&
                          i.composedPath &&
                          i.composedPath().shift()) ||
                        i.target;
                      b(f, t.componentNode, t.props.outsideClickIgnoreClass) ===
                        document && t.__outsideClickHandler(i);
                    }
                  }),
    ...
    (o.displayName = 'OnClickOutside(' + u + ')'),
    (o.defaultProps = {
